...
def convert_video_hls(source, resolution, suffix):
    # Erzeuge den Dateinamen für die transkodierte Datei
    base, _ = os.path.splitext(source)
    target_file = f"{base}_{suffix}.mp4"
    # Transkodierung in die gewünschte Auflösung (hier 480p oder 720p)
    cmd_transcode = (
    ...
    # Erstelle einen HLS-Ordner für diese Qualitätsstufe
    ...
    # Erzeuge die HLS-Playlist aus der transkodierten Datei
    cmd_hls = (
